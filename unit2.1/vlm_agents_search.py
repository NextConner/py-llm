...
from smolagents import CodeAgent, InferenceClientModel, ActionStep,DuckDuckGoSearchTool
...
model = InferenceClientModel(model_id="Qwen/Qwen2-VL-7B-Instruct", provider="together")
